...
```{r, echo=FALSE}
survey <- cbind(personinfo,surveyanswers)
colnames(surveyanswers)[c(grep("PL1a _Contributes",colnames(surveyanswers)))] <- "PL1a_Contributes"
colnames(surveyanswers)[c(grep("PL6c_Contributes.1",colnames(surveyanswers)))] <- "PL6c_Contributes"
...
PL1 <- 'pl1 =~ PL1a_Contributes + PL1b_Contributes + PL1c_Contributes + PL1d_Contributes + PL1f_Contributes
PL1a_Contributes ~~ PL1f_Contributes'
...
PL2 <- 'pl2 =~ aa*PL2a_Contributes + aa*PL2b_Contributes + PL2c_Contributes'
...
PL3 <- 'pl3 =~ PL3a_Contributes + aa*PL3d_Contributes + aa*PL3e_Contributes'
...
PL4 <- 'pl4 =~ aa*PL4a_Contributes + aa*PL4b_Contributes + PL4c_Contributes'
...
PL6 <- 'pl6 =~ aa*PL6a_Contributes + aa*PL6b_Contributes + PL6c_Contributes'
...
PL7 <- 'pl7 =~ aa*PL7a_Contributes + PL7b_Contributes + aa*PL7c_Contributes'
...
PL8 <- 'pl8 =~ PL8a_Contributes + aa*PL8b_Contributes + aa*PL8c_Contributes'
...
LT2 <- 'lt2 =~ aa*LT2a_Contributes + aa*LT2b_Contributes + LT2c_Contributes'
...
LT3 <- 'lt3 =~ LT3a_Contributes + aa*LT3b_Contributes + aa*LT3d_Contributes'
...
LT4 <- 'lt4 =~ LT4a_Contributes + aa*LT4b_Contributes + aa*LT4c_Contributes'
...
LE1model<-'LE1 =~LE1a_Contributes+LE1b_Contributes+LE1c_Contributes+LE1d_Contributes'
...
LE2model<-'LE2 =~LE2a_Contributes+LE2c_Contributes+LE2d_Contributes+LE2f_Contributes'
...
LE3model<-'LE3 =~LE3a_Contributes+LE3b_Contributes+LE3d_Contributes+LE3e_Contributes+LE3f_Contributes'
...
LE4model<-'LE4 =~LE4a_Contributes+LE4b_Contributes+LE4c_Contributes+LE4d_Contributes'
...
LE5model<-'LE5 =~aa*LE5a_Contributes+aa*LE5c_Contributes+LE5d_Contributes'
...
Since p-value of the third subdomain is 0.008 < 0.05, and question "LT3c_Contributes" has the lowest factor loading 0.604, we drop "LT3_c_Contributes" and then remodel the third subdomain. 

```{r echo=FALSE, message=FALSE, warning=FALSE }
LT3_new <- 'lt3 =~ LT3a_Contributes + aa*LT3b_Contributes + aa*LT3d_Contributes'
...
After we remodel the third subdomain, the p-value of third domain is 0.897 > 0.05. Then we can save all the remaining questions in the third subdomain ("LT3a_Contributes", "LT3b_Contributes", "LT3d_Contributes"). 
...
```{r,echo=F}
LE2model<-'LE2 =~LE2b_Contributes+LE2c_Contributes+LE2d_Contributes+LE2e_Contributes+LE2f_Contributes'
fitLE2 <- cfa(LE2model,data=PL.factor)
summary(fitLE2)
parameterEstimates(fitLE2, standardized=TRUE) %>% 
  filter(op == "=~") %>% 
...
## Third Subdomain
```{r,echo=F}
LE3model<-'LE3 =~LE3a_Contributes+LE3b_Contributes+LE3c_Contributes+LE3d_Contributes+LE3e_Contributes+LE3f_Contributes+LE3g_Contributes'
...
## Fourth Subdomain
```{r,echo=F}
LE4model<-'LE4 =~LE4a_Contributes+LE4b_Contributes+LE4c_Contributes+LE4d_Contributes+LE4e_Contributes'
...
## Sixth subdomain
```{r,echo=F}
LE6model<-'LE6 =~LE6a_Contributes+LE6b_Contributes+LE6c_Contributes+LE6d_Contributes'
