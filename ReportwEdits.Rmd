...
PL1table <- c("PL1","PL1a,PL1b,PL1c,PL1d,PL1f",0.085, round(fitMeasures(fit1)[c("cfi")],digits=3),round(fitMeasures(fit1)[c("tli")],digits=3))
...
PL2table <- c("PL2","PL2a,PL2b,PL2c",0.8, round(fitMeasures(fit2)[c("cfi")],digits=3),round(fitMeasures(fit2)[c("tli")],digits=3))
...
PL3table <- c("PL3","PL3a,PL3d,PL3e",0.772, round(fitMeasures(fit3)[c("cfi")],digits=3),round(fitMeasures(fit3)[c("tli")],digits=3))
...
PL4table <- c("PL4","PL4a,PL4b,PL4c",0.221, round(fitMeasures(fit4)[c("cfi")],digits=3),round(fitMeasures(fit4)[c("tli")],digits=3))
...
PL6table <- c("PL6","PL6a,PL6b,PL6c",0.362, round(fitMeasures(fit6)[c("cfi")],digits=3),round(fitMeasures(fit6)[c("tli")],digits=3))
...
PL7table <- c("PL7","PL7a,PL7b,PL7c",0.409, round(fitMeasures(fit7)[c("cfi")],digits=3),round(fitMeasures(fit7)[c("tli")],digits=3))
...
PL8table <- c("PL8","PL8a,PL8b,PL8c",0.724, round(fitMeasures(fit8)[c("cfi")],digits=3),round(fitMeasures(fit8)[c("tli")],digits=3))
```
